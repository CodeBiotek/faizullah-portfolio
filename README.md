...
<html lang="en">
  <head>
    ...
    <style>
      ...
      /* CSS Animation of Laptop & Coffee Cup */
      .anim-container {
        position: relative;
        width: 250px;
        height: 200px;
      ...
      .anim-container .laptop,
      .anim-container .coffee-cup {
        position: absolute;
      ...
      .anim-container .laptop {
        width: 200px;
        height: 130px;
        background: linear-gradient(145deg, #6a00ff, #ff00ff);
        border-radius: 10px;
        top: 40px;
        left: 25px;
      }
      .anim-container .coffee-cup {
        width: 50px;
        height: 80px;
        background: linear-gradient(145deg, #ff00ff, #ff6a00);
        border-radius: 25px;
        top: 10px;
        left: 0;
      }
